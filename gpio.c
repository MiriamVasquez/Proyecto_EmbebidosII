...
//    SetPin_GPIO(GREEN_LED_PORT, GREEN_LED_PIN);
    SetPin_GPIO(LED1_PORT, LED1_PIN);
    SetPin_GPIO(LED2_PORT, LED2_PIN);
    SetPin_GPIO(PINH_PORT, PINH_PIN);
    SetPin_GPIO(PINL_PORT, PINL_PIN);
...
//    SET_PIN_AS_OUTPUT(GREEN_LED_GPIO,GREEN_LED_MASK);
    SET_PIN_AS_OUTPUT(LED1_GPIO,LED1_MASK);
    SET_PIN_AS_OUTPUT(LED2_GPIO,LED2_MASK);
    SET_PIN_AS_OUTPUT(PINH_GPIO,PINH_MASK);
    SET_PIN_AS_OUTPUT(LED2_GPIO,PINL_MASK);
}
